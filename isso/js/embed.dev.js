...
define('app/i18n/ja',{
    "postbox-text": "コメントを入力 (3文字以上)",
    "postbox-author": "名前 (任意)",
    "postbox-email": "メールアドレス (任意)",
    "postbox-website": "Web サイト (任意)",
    "postbox-submit": "提出",

    "num-comments": "１件のコメント\n{{ n }} 件のコメント",
    "no-comments": "コメントがありません。",
...
define('app/i18n',["app/config", "app/i18n/de", "app/i18n/en", "app/i18n/fr", "app/i18n/ru", "app/i18n/it", "app/i18n/ja"], function(config, de, en, fr, ru, it, ja) {
...
buf.push("<div class=\"isso-postbox\"><div class=\"form-wrapper\"><div class=\"textarea-wrapper\"><div contenteditable=\"true\" class=\"textarea placeholder\">" + (jade.escape(null == (jade_interp = i18n('postbox-text')) ? "" : jade_interp)) + "</div></div><section class=\"auth-section\"><p class=\"input-wrapper\"><input type=\"hidden\" name=\"author\"" + (jade.attr("placeholder", i18n('postbox-author'), true, false)) + "/></p><p class=\"input-wrapper\"><input type=\"hidden\" name=\"email\"" + (jade.attr("placeholder", i18n('postbox-email'), true, false)) + "/></p><p class=\"input-wrapper\"><input type=\"hidden\" name=\"website\"" + (jade.attr("placeholder", i18n('postbox-website'), true, false)) + "/></p><p class=\"post-action\"><input type=\"submit\"" + (jade.attr("value", i18n('postbox-submit'), true, false)) + "/></p></section></div></div>");}("i18n" in locals_for_with?locals_for_with.i18n:typeof i18n!=="undefined"?i18n:undefined));;return buf.join("");
};  return fn;});
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (comment, conf, datetime, i18n, svg) {
...
buf.push("<div class=\"text-wrapper\"><div role=\"meta\" class=\"isso-comment-header\"><a" + (jade.attr("href", '#isso-' + (comment.id) + '', true, false)) + " class=\"permalink\"><date" + (jade.attr("datetime", '' + (datetime(comment.created)) + '', true, false)) + "></date></a><span class=\"note\">" + (jade.escape(null == (jade_interp = comment.mode == 2 ? i18n('comment-queued') : comment.mode == 4 ? i18n('comment-deleted') : '') ? "" : jade_interp)) + "</span></div><div class=\"text\">");
if ( comment.mode == 4)
{
buf.push("<p>&nbsp;</p>");
}
...
define('embed',["app/lib/ready", "app/config", "app/i18n", "app/api", "app/isso", "app/count", "app/dom", "app/text/css", "app/text/svg", "app/jade"], function(domready, config, i18n, api, isso, count, $, css, svg, jade) {
